...
Preserve GitHub/canonical repository truth, the replaceable MemoryProvider contract, and the local-RAG fallback. HIVE memory alone never promotes or mutates canonical Hive Plan/HIVE state.
